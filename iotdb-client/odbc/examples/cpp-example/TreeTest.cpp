...
void Query(SQLHDBC hDbc) {
  ...
  try {
    ...
    const std::string sqlQuery =
        "SELECT * FROM root.full.fulldevice WHERE time >= 1735689600000 AND time <= 1735690790000";
...
int main() {
  ...
  try {
    ...
    std::string connectionString = "DSN=" + dsn + ";Server=" + server + ";UID=" + user +
                                   ";PWD=" + password + ";loglevel=4;istablemodel=0";
    ...
    const char* insertStatements[] = {
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735689600000, true, "
        "100, 10000000000, 36.5, 128.689, 'Device running normally', 'DeviceA-Room1', "
        "1735689600000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735689660000, false, "
        "101, 10000000001, 36.6, 128.789, 'Device running normally', 'DeviceA-Room1', "
        "1735689660000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735689720000, true, "
        "102, 10000000002, 36.7, 128.889, 'Device running normally', 'DeviceA-Room1', "
        "1735689720000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735689780000, false, "
        "103, 10000000003, 36.8, 128.989, 'Device high temperature alert', 'DeviceA-Room1', "
        "1735689780000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735689840000, true, "
        "104, 10000000004, 36.9, 129.089, 'Device status restored', 'DeviceA-Room1', "
        "1735689840000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735689900000, false, "
        "105, 10000000005, 37.0, 129.189, 'Device running normally', 'DeviceB-Room2', "
        "1735689900000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735689960000, true, "
        "106, 10000000006, 37.1, 129.289, 'Device running normally', 'DeviceB-Room2', "
        "1735689960000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690020000, false, "
        "107, 10000000007, 37.2, 129.389, 'Device low humidity alert', 'DeviceB-Room2', "
        "1735690020000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690080000, true, "
        "108, 10000000008, 37.3, 129.489, 'Device status restored', 'DeviceB-Room2', "
        "1735690080000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690140000, false, "
        "109, 10000000009, 37.4, 129.589, 'Device running normally', 'DeviceC-Room3', "
        "1735690140000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690200000, true, "
        "110, 10000000010, 37.5, 129.689, 'Device running normally', 'DeviceC-Room3', "
        "1735690200000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690260000, false, "
        "111, 10000000011, 37.6, 129.789, 'Device unstable voltage alert', 'DeviceC-Room3', "
        "1735690260000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690320000, true, "
        "112, 10000000012, 37.7, 129.889, 'Device status restored', 'DeviceC-Room3', "
        "1735690320000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690380000, false, "
        "113, 10000000013, 37.8, 129.989, 'Device running normally', 'DeviceD-Room4', "
        "1735690380000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690440000, true, "
        "114, 10000000014, 37.9, 130.089, 'Device running normally', 'DeviceD-Room4', "
        "1735690440000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690500000, false, "
        "115, 10000000015, 38.0, 130.189, 'Device running normally', 'DeviceD-Room4', "
        "1735690500000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690560000, true, "
        "116, 10000000016, 38.1, 130.289, 'Device signal interrupted alert', 'DeviceD-Room4', "
        "1735690560000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690620000, false, "
        "117, 10000000017, 38.2, 130.389, 'Device running normally', 'DeviceE-Room5', "
        "1735690620000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690680000, true, "
        "118, 10000000018, 38.3, 130.489, 'Device running normally', 'DeviceE-Room5', "
        "1735690680000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690740000, false, "
        "119, 10000000019, 38.4, 130.589, 'Device running normally', 'DeviceE-Room5', "
        "1735690740000, '2026-01-04')",
        "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, "
        "double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735690790000, false, "
        "119, 10000000019, 38.4, 130.589, 'Device running normally', 'DeviceE-Room5', "
        "1735690740000, '2026-01-04')"};
