...
int main() {
    ...
    try {
        ...
        const char* insertStatements[] = {
            "INSERT INTO root.full.fulldevice(timestamp, bool_col, int32_col, int64_col, float_col, double_col, text_col, string_col, timestamp_col, date_col) VALUES (1735689600000, true, 100, 10000000000, 36.5, 128.689, 'Device running normally', 'DeviceA-Room1', 1735689600000, '2026-01-04')",
